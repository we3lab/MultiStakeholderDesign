...
The code chunk below generates the four panels of Figure 2 in the paper. 
...
#Changing Coefficient order

regression.analysis.raw.lognormal$Task <- factor(regression.analysis.raw.lognormal$Task, levels = c("bCollaborationTask", "cCADSTask", "aIndividualTask"))
...
#Change back level order for table generation
regression.analysis.raw.lognormal$Task <- factor(regression.analysis.raw.lognormal$Task, levels = c("aIndividualTask", "bCollaborationTask", "cCADSTask"))
...
#Generating Results for Figure 4
ggplot() +
